...
struct BigTriangle : public Object {
  ...
  void createShader() {
    ...
    GFXUniformList nearFarUniform = {{"u_near", GFXType::FLOAT, 1},
                                     {"u_far", GFXType::FLOAT, 1}};
    GFXUniformBlockList uniformBlockList = {
        {GFXShaderType::FRAGMENT, 0, "Near_Far_Uniform", nearFarUniform}};
  ...
  void createBuffers() {
    ...
    GFXBufferInfo vertexBufferInfo = {GFXBufferUsage::VERTEX,
                                      GFXMemoryUsage::DEVICE, 2 * sizeof(float),
                                      sizeof(vertices), GFXBufferFlagBit::NONE};
    ...
    GFXBufferInfo uniformBufferInfo = {
        GFXBufferUsage::UNIFORM, GFXMemoryUsage::DEVICE, sizeof(float),
        2 * sizeof(float), GFXBufferFlagBit::NONE};
  ...
  void createPipeline() {
    texBindingLoc = 1;
    GFXBindingList bindingList = {{GFXShaderType::FRAGMENT, 0,
                                   GFXBindingType::UNIFORM_BUFFER,
                                   "Near_Far_Uniform", 1},
                                  {GFXShaderType::FRAGMENT, texBindingLoc,
                                   GFXBindingType::SAMPLER, "u_texture", 1}};
...
struct Bunny : public Object {
  Bunny(GFXDevice *_device, GFXFramebuffer *_fbo) : device(_device) {
    createShader();
    createBuffers();
    createInputAssembler();
    createPipeline(_fbo);
...
//
    ...
    GFXUniformList mvpMatrix = {{"u_model", GFXType::MAT4, 1},
  ...
  void createBuffers() {
    ...
    GFXBufferInfo vertexBufferInfo = {
        GFXBufferUsage::VERTEX, GFXMemoryUsage::DEVICE, 3 * sizeof(float),
        sizeof(bunny_positions), GFXBufferFlagBit::NONE};
    ...
    GFXBufferInfo indexBufferInfo = {
        ...
        sizeof(bunny_cells), GFXBufferFlagBit::NONE};
    ...
    GFXBufferInfo uniformBufferInfo = {
        ...
        sizeof(Mat4), 3 * sizeof(Mat4), GFXBufferFlagBit::NONE};
...
bool DepthTexture::initialize() {
  ...
  depthStecnilTexInfo.usage = GFXTextureUsageBit::DEPTH_STENCIL_ATTACHMENT |
...
void DepthTexture::tick(float dt) {
  ...
  for (auto commandBuffer : _commandBuffers) {
    ...
    commandBuffer->beginRenderPass(
        _bunnyFBO->framebuffer, render_area, GFXClearFlagBit::DEPTH,
