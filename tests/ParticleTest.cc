...
//    };
//
//    vertex main0_out main0(main0_in in [[stage_in]], constant MVP_Matrix& _13
//    [[buffer(0)]])
//    {
//        main0_out out = {};
...
//    {
//        main0_out out = {};
//        out.o_color = in.v_color * u_texture.sample(u_textureSmplr,
//        in.v_texcoord); return out;
//    }
//    )";
//#else
#if defined(USE_VULKAN) || defined(USE_METAL)
...
void ParticleTest::createVertexBuffer() {
  ...
  GFXBufferInfo vertexBufferInfo = {
      GFXBufferUsage::VERTEX, GFXMemoryUsage::DEVICE | GFXMemoryUsage::HOST,
  ...
  GFXBufferInfo indexBufferInfo = {
      GFXBufferUsage::INDEX, GFXMemoryUsage::DEVICE, sizeof(uint16_t),
      sizeof(_ibufferArray), GFXBufferFlagBit::NONE};
  ...
  GFXBufferInfo uniformBufferInfo = {GFXBufferUsage::UNIFORM,
...
void ParticleTest::createPipeline() {
  GFXBindingList bindingList = {
      {GFXShaderType::VERTEX, 0, GFXBindingType::UNIFORM_BUFFER, "MVP_Martix",
       1},
