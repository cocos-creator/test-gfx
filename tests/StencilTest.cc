...
void StencilTest::createBuffers() {
  ...
  GFXBufferInfo uniformBufferInfo = {
      ...
      sizeof(Mat4), sizeof(Mat4), GFXBufferFlagBit::NONE};
...
void StencilTest::createPipelineState() {
  GFXBindingList bindingList = {
      {GFXShaderType::VERTEX, 0, GFXBindingType::UNIFORM_BUFFER, "u_mvpMatrix",
       1},
  ...
  pipelineInfo[(uint8_t)PipelineType::CAVAS]
      ...
      pipelineInfo[(uint8_t)PipelineType::CAVAS]
          .depthStencilState.stencilFuncBack = GFXComparisonFunc::NEVER;
  pipelineInfo[(uint8_t)PipelineType::CAVAS]
  ...
  pipelineInfo[(uint8_t)PipelineType::CAVAS]
      ...
      pipelineInfo[(uint8_t)PipelineType::CAVAS]
          .depthStencilState.stencilFailOpBack = GFXStencilOp::REPLACE;
  pipelineInfo[(uint8_t)PipelineType::CAVAS]
      .depthStencilState.stencilZFailOpFront =
      pipelineInfo[(uint8_t)PipelineType::CAVAS]
          .depthStencilState.stencilZFailOpBack = GFXStencilOp::KEEP;
  pipelineInfo[(uint8_t)PipelineType::CAVAS]
      .depthStencilState.stencilPassOpFront =
      pipelineInfo[(uint8_t)PipelineType::CAVAS]
          .depthStencilState.stencilPassOpBack = GFXStencilOp::KEEP;
  ...
  pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
      .depthStencilState.stencilFuncFront =
      pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
          .depthStencilState.stencilFuncBack = GFXComparisonFunc::EQUAL;
  pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
      .depthStencilState.stencilReadMaskFront =
      pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
          .depthStencilState.stencilReadMaskBack = 0xFF;
  ...
  pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
      .depthStencilState.stencilFailOpFront =
      pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
          .depthStencilState.stencilFailOpBack = GFXStencilOp::KEEP;
  pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
      .depthStencilState.stencilZFailOpFront =
      pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
          .depthStencilState.stencilZFailOpBack = GFXStencilOp::KEEP;
  ...
  pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
      ...
      pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
          .depthStencilState.stencilRefBack = 0x1;
  pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
      .rasterizerState.cullMode = GFXCullMode::NONE;
  pipelineInfo[(uint8_t)PipelineType::FRONT_BACK_STENCIL]
      .dynamicStates.push_back(GFXDynamicState::VIEWPORT);
  ...
  pipelineInfo[(uint8_t)PipelineType::BACK_STENCIL]
      ...
      pipelineInfo[(uint8_t)PipelineType::BACK_STENCIL]
          .depthStencilState.stencilTestBack = true;
  pipelineInfo[(uint8_t)PipelineType::BACK_STENCIL]
      .depthStencilState.stencilFuncFront = GFXComparisonFunc::ALWAYS;
  pipelineInfo[(uint8_t)PipelineType::BACK_STENCIL]
      .depthStencilState.stencilFuncBack = GFXComparisonFunc::EQUAL;
  pipelineInfo[(uint8_t)PipelineType::BACK_STENCIL]
      .depthStencilState.stencilReadMaskFront =
  ...
  pipelineInfo[(uint8_t)PipelineType::FRONT_STENCIL]
      ...
      pipelineInfo[(uint8_t)PipelineType::FRONT_STENCIL]
          .depthStencilState.stencilTestBack = true;
  pipelineInfo[(uint8_t)PipelineType::FRONT_STENCIL]
      .depthStencilState.stencilFuncFront = GFXComparisonFunc::EQUAL;
  pipelineInfo[(uint8_t)PipelineType::FRONT_STENCIL]
      .depthStencilState.stencilFuncBack = GFXComparisonFunc::ALWAYS;
  pipelineInfo[(uint8_t)PipelineType::FRONT_STENCIL]
      .depthStencilState.stencilReadMaskFront =
      pipelineInfo[(uint8_t)PipelineType::FRONT_STENCIL]
          .depthStencilState.stencilReadMaskBack = 0xFF;
