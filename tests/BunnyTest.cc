...
namespace cc {
    ...
    void main () {
        ...
        gfx::GFXUniformList color = { {"u_color", gfx::GFXType::FLOAT4, 1} };
        gfx::GFXUniformBlockList uniformBlockList = {
            {gfx::GFXShaderType::VERTEX, static_cast<uint>(Binding::MVP), "MVP_Matrix",
             mvpMatrix},
            {gfx::GFXShaderType::FRAGMENT, static_cast<uint>(Binding::COLOR), "Color",
             color} };
    ...
    void BunnyTest::createBuffers() {
        ...
        _vertexBuffer->update((void *)&bunny_positions[0][0], 0,
            sizeof(bunny_positions));

        // index buffer
        gfx::GFXBufferInfo indexBufferInfo = { gfx::GFXBufferUsage::INDEX,
                                         gfx::GFXMemoryUsage::DEVICE, sizeof(uint16_t),
        ...
        // mvp matrix uniform
        gfx::GFXBufferInfo mvpMatrixInfo = { gfx::GFXBufferUsage::UNIFORM,
        ...
        // color uniform
        gfx::GFXBufferInfo colorInfo = { gfx::GFXBufferUsage::UNIFORM, gfx::GFXMemoryUsage::DEVICE,
    ...
    void BunnyTest::createPipelineState() {
        gfx::GFXBindingList bindingList = {
            {gfx::GFXShaderType::VERTEX, static_cast<uint>(Binding::MVP),
             gfx::GFXBindingType::UNIFORM_BUFFER, "MVP_Matrix", 1},
            {gfx::GFXShaderType::FRAGMENT, static_cast<uint>(Binding::COLOR),
             gfx::GFXBindingType::UNIFORM_BUFFER, "Color", 1} };
        ...
        gfx::GFXPipelineStateInfo pipelineStateInfo;
        pipelineStateInfo.primitive = gfx::GFXPrimitiveMode::TRIANGLE_LIST;
        ...
        pipelineStateInfo.depthStencilState.depthFunc = gfx::GFXComparisonFunc::LESS;
