...
void BunnyTest::createShader() {
  ...
  GFXUniformBlockList uniformBlockList = {
      {GFXShaderType::VERTEX, static_cast<uint>(Binding::MVP), "MVP_Matrix",
       mvpMatrix},
      {GFXShaderType::FRAGMENT, static_cast<uint>(Binding::COLOR), "Color",
       color}};
...
void BunnyTest::createBuffers() {
  ...
  // index buffer
  GFXBufferInfo indexBufferInfo = {GFXBufferUsage::INDEX,
                                   GFXMemoryUsage::DEVICE, sizeof(uint16_t),
  ...
  // mvp matrix uniform
  GFXBufferInfo mvpMatrixInfo = {GFXBufferUsage::UNIFORM,
                                 GFXMemoryUsage::DEVICE, sizeof(Mat4),
                                 3 * sizeof(Mat4), GFXBufferFlagBit::NONE};
  ...
  // color uniform
  GFXBufferInfo colorInfo = {GFXBufferUsage::UNIFORM, GFXMemoryUsage::DEVICE,
...
void BunnyTest::createPipelineState() {
  GFXBindingList bindingList = {
      {GFXShaderType::VERTEX, static_cast<uint>(Binding::MVP),
       GFXBindingType::UNIFORM_BUFFER, "MVP_Matrix", 1},
      {GFXShaderType::FRAGMENT, static_cast<uint>(Binding::COLOR),
       GFXBindingType::UNIFORM_BUFFER, "Color", 1}};
