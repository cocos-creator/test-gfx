...
struct Quad : public cc::Object {
    ...
    void createPipeline() {
        ...
        pipelineInfo[NO_BLEND].blendState.targets.push_back(new gfx::BlendTarget());
        ...
        pipelineInfo[NORMAL_BLEND].blendState.targets.push_back(new gfx::BlendTarget());
        ...
        pipelineInfo[ADDITIVE_BLEND].blendState.targets.push_back(new gfx::BlendTarget());
        ...
        pipelineInfo[SUBSTRACT_BLEND].blendState.targets.push_back(new gfx::BlendTarget());
        ...
        pipelineInfo[MULTIPLY_BLEND].blendState.targets.push_back(new gfx::BlendTarget());
