...
struct Quad : public cc::Object {
    ...
    void createPipeline() {
        ...
        gfx::BlendTarget noBlend;
        noBlend.blend = true;
        noBlend.blendEq = gfx::BlendOp::ADD;
        noBlend.blendAlphaEq = gfx::BlendOp::ADD;
        noBlend.blendSrc = gfx::BlendFactor::ONE;
        noBlend.blendDst = gfx::BlendFactor::ZERO;
        noBlend.blendSrcAlpha = gfx::BlendFactor::ONE;
        noBlend.blendDstAlpha = gfx::BlendFactor::ONE_MINUS_SRC_ALPHA;
        pipelineInfo[NO_BLEND].blendState.targets.push_back(noBlend);
        ...
        gfx::BlendTarget normalBlend;
        normalBlend.blend = true;
        normalBlend.blendEq = gfx::BlendOp::ADD;
        normalBlend.blendAlphaEq = gfx::BlendOp::ADD;
        normalBlend.blendSrc = gfx::BlendFactor::SRC_ALPHA;
        normalBlend.blendDst = gfx::BlendFactor::ONE_MINUS_SRC_ALPHA;
        normalBlend.blendSrcAlpha = gfx::BlendFactor::ONE;
        normalBlend.blendDstAlpha = gfx::BlendFactor::ONE_MINUS_SRC_ALPHA;
        pipelineInfo[NORMAL_BLEND].blendState.targets.push_back(normalBlend);
        ...
        gfx::BlendTarget additiveBlend;
        additiveBlend.blend = true;
        additiveBlend.blendEq = gfx::BlendOp::ADD;
        additiveBlend.blendAlphaEq = gfx::BlendOp::ADD;
        additiveBlend.blendSrc = gfx::BlendFactor::SRC_ALPHA;
        additiveBlend.blendDst = gfx::BlendFactor::ONE;
        additiveBlend.blendSrcAlpha = gfx::BlendFactor::ONE;
        additiveBlend.blendDstAlpha = gfx::BlendFactor::ONE_MINUS_SRC_ALPHA;
        pipelineInfo[ADDITIVE_BLEND].blendState.targets.push_back(additiveBlend);
        ...
        gfx::BlendTarget subBlend;
        subBlend.blend = true;
        subBlend.blendEq = gfx::BlendOp::ADD;
        subBlend.blendAlphaEq = gfx::BlendOp::ADD;
        subBlend.blendSrc = gfx::BlendFactor::ZERO;
        subBlend.blendDst = gfx::BlendFactor::ONE_MINUS_SRC_COLOR;
        subBlend.blendSrcAlpha = gfx::BlendFactor::ONE;
        subBlend.blendDstAlpha = gfx::BlendFactor::ONE_MINUS_SRC_ALPHA;
        pipelineInfo[SUBSTRACT_BLEND].blendState.targets.push_back(subBlend);
        ...
        gfx::BlendTarget multiplyBlend;
        multiplyBlend.blend = true;
        multiplyBlend.blendEq = gfx::BlendOp::ADD;
        multiplyBlend.blendAlphaEq = gfx::BlendOp::ADD;
        multiplyBlend.blendSrc = gfx::BlendFactor::ZERO;
        multiplyBlend.blendDst = gfx::BlendFactor::SRC_COLOR;
        multiplyBlend.blendSrcAlpha = gfx::BlendFactor::ONE;
        multiplyBlend.blendDstAlpha = gfx::BlendFactor::ONE_MINUS_SRC_ALPHA;
        pipelineInfo[MULTIPLY_BLEND].blendState.targets.push_back(multiplyBlend);
